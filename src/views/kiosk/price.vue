        ...
        <v-row>
          <v-col cols="12" md="6">
            <dl>
              ...
              <dd>
                <span>앞문, 뒷문 개폐형</span>
                <span>바닥으로부터 높이 850/ (가로480* 세로1030) 벽면 타공작업</span>
                <span>220v 1개 / LAN케이블 1개</span>
              </dd>
            </dl>
          </v-col>
          <v-col cols="12" md="6">
...
export default {
  data() {
    return {
      carousel: 0,
      carouselData: [
        { url: "img/sub-visual01.jpg" },
        { url: "img/sub-visual02.jpg" },
        { url: "img/sub-visual03.jpg" },
      ],
    };
  },
  methods:{
